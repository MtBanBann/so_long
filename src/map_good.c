...
static int	map_dup_good(char **map_dup, int height, int width);
static int	map_completed(char **map, int i, int y, int p);
static int	map_while(char **map_dup, t_map *so_map, int p);
static int	map_two(char **map_dup, size_t len, t_map *so_map);
